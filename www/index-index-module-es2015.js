...
const routes = [
    ...
    {
        path: 'measurement',
        loadChildren: () => __webpack_require__.e(/*! import() | measurement-measurement-module */ "measurement-measurement-module").then(__webpack_require__.bind(null, /*! ../measurement/measurement.module */ "./src/app/measurement/measurement.module.ts")).then(m => m.MeasurementPageModule)
    },
    {
        path: 'tab2',
